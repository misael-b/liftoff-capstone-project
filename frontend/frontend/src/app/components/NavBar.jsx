...
const NavBar = () => {
  ...
  return (
    ...
    <div className="navbar">
        ...
        <Link href='http://localhost:3000/posts'><img src="https://p7.hiclipart.com/preview/363/100/908/computer-icons-marketplace-shopping-iconfinder-market-stand-icon-thumbnail.jpg" alt="Listings" id="posts" /></Link>
